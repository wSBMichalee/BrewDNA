...
class ScanningAnalyzingScreen extends StatefulWidget {
  ...
  @override
  State<ScanningAnalyzingScreen> createState() =>
      _ScanningAnalyzingScreenState();
}

class _ScanningAnalyzingScreenState extends State<ScanningAnalyzingScreen>
  ...
  void _showResultSheet(BuildContext context, beer) {
    showModalBottomSheet(
      ...
      if (mounted &&
          GoRouterState.of(context).uri.toString().contains('/scanning')) {
        context.pop();
      }
    });
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: CupertinoButton.filled(
                  ...
                  child: Text(AppLocalizations.of(context)!.scanningAnalyzingTryAgain),
                ),
              ),
            ],
          ),
